<template>
    <div class="wrapper-chat" :style="getWrapperStyle">
        ...
        <!-- <div class="speedo-placementGP" v-if="isInVehicle">
            <SpeedoGP
                :isMetric="isMetric"
                :speed="speed"
                :gear="gear"
                ...
                :type="type"
                :mileage="mileage"
                :turnSignalsLeft="turnSignalsLeft"
                :turnSignalsRight="turnSignalsRight"
            />
        </div> -->
        ...
        <div class="speedo-placement" v-if="isInVehicle && hudState !== hudStateNames.HIDDEN">
            <Speed :unit="unit" :speed="speed" :gear="gear" :isMetric="isMetric" />
